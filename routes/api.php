...
Route::middleware(['auth:api'])->group(function () {
    ...
    Route::get('/orders/my', [OrderController::class, 'myOrders']); // Get my orders
...
Route::prefix('driver')->group(function () {
    Route::post('register', [DriverController::class, 'register']);       // تسجيل سائق
    Route::post('login', [DriverController::class, 'login']);             // تسجيل دخول السائق
    Route::get('me', [DriverController::class, 'me'])->middleware('auth:api'); // بيانات السائق
